    ...
    return (
        <div>
            ...
            <div className='flex flex-col lg:flex-row p-5 lg:p-3 gap-3 lg:gap-5 items-center justify-center overflow-hidden'>
                ...
                <iframe className='w-full h-full' src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1832653.9176706497!2d-77.18889405760166!3d24.370463537856946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sma!4v1751459217791!5m2!1sen!2sma" width='auto' height="auto" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                </div>
                    ...
                    <form className='w-full' ref={form} onSubmit={sendEmail}>
                        <div>
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-black/50 font-semibold mb-2">Phone</label>
                                    <input
                                        type="tel"
                                        name="user_phone"
                                        className="w-full  border border-gray-700 rounded-lg px-4 py-3 text-black  focus:outline-none transition-colors"
